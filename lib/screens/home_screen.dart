      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                crd(clr: primaryColor, txt: "Welcome")
              ],
            ),
            Stack(
...
// Text Box
            ...
            Row(
              ...
              children: [
                SizedBox(width: w*0.0149,),
                first(t1: "Fee overview : ", t2: "Amount Received : 5500", t3: "Payers : 3", cl1: secondaryColor, cl: primaryColor, s1: h*0.0165,
                    onprs: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>feeDetails()));
                }),
                first(t1: "Accounts Overview :", t2: "Income : 65000", t3: "Expense : 25000", cl1: secondaryColor, cl: primaryColor, s1: h* 0.017,
                onprs: (){
            ...
            SizedBox(height: h*0.005,),
            second(t1: "Circular :", t2: "Annual day celebration at 25th at this month.", cl1: secondaryColor,s1: h*0.019,cl: primaryColor,
            onprs: (){
                    ...
                    child: Column(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            IconButton(onPressed: onprs, icon: Icon(Icons.arrow_circle_right,size: h*0.041,color: cl,)),
                          ],
                        )
                      ],
                    )
    ...
    return Card(
          ...
          child: Container(
            ...
            child: Container(
                ...
                child:
                Padding(padding: EdgeInsets.fromLTRB(9, 9, 9, 2),
                    child: Column(
                      children: [
                        Row(
                          children: [
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(t2,style: GoogleFonts.poppins(fontSize: s1),)
                                  ],
                                ),
                              ),
                            )
                    ...
                    children: [
                            ...
                            child: SfCircularChart(
                              series: <CircularSeries>[
                                DoughnutSeries<AttendencdataType, String>(
                                  ...
                                  xValueMapper: (AttendencdataType data, _) => data.status,
                                  yValueMapper: (AttendencdataType data, _) => data.value,
                                  pointColorMapper: (AttendencdataType data, _) => data.color,
                                  innerRadius: '60%',
                      ...
                      Column(
                        children: [
                          Text(t2,style: GoogleFonts.poppins(
                              ...
                              fontSize: h*0.019
                          ),),Text(t4,style: GoogleFonts.poppins(
                              fontSize: h*0.019
                          ),),
                          SizedBox(height: h*0.03,),
                          Column(
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(t5,style: GoogleFonts.poppins(
                                      fontSize: h*0.019
                                  ),)
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: w*0.01,),
                                  Text(t6,style: GoogleFonts.poppins(
                                      fontSize: h*0.019
                                  ),)
                                ],
                              ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          }, icon: Icon(Icons.arrow_circle_right,size: h*0.0455,color: cl,)),
                        ],
                      )
                    ],
                  ),
