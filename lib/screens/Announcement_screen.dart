...
class _announcementState extends State<announcement> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBarWidget(title: "Announcements", color: secondaryColor,),
      drawer: Drawer(
        child: Column(
          children: <Widget>[
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                textwidget(text: "Today's Announcements :",s1: h*0.02,wt: FontWeight.w700)
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                second(t1: "Circular :", t2: "Annual day celebration at 25th at this month.",
                  cl1: secondaryColor,s1: h*0.019,
                )
              ],
            ),
            SizedBox(height: h*0.04,),
            Row(
              ...
              children: [
                SizedBox(width: w*0.03,),
                textwidget(text: "Create Announcement :",s1: h*0.02,wt: FontWeight.w700)
              ],
            ),
            SizedBox(height: h*0.02,),
            cntr1(txt1: "Title :"),
            ...
            Row(
              children: [
                ...
                textwidget(text: "Announcement :",s1: h*0.02,wt: FontWeight.w700)
              ],
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                crd1(clr: primaryColor,txt: "Publish",sizew: w*0.25,wt: FontWeight.w500),
                crd1(clr: color4,txt: "Save Draft",sizew: w*0.33,wt: FontWeight.w500),
              ],
            )
            ],
        ),
